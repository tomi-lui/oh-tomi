              ...
              return (
                <Link 
                  ...
                  className={`flex flex-col gap-4 ${
                    index % 2 === 0 
                      ? 'items-start mr-8 md:mr-0' 
                      : 'items-end ml-8 md:ml-0'
                  }`}
                >
                  <motion.div
                    ref={cardRef}
                  ...
                  >
                    ...
                    <div
                      className={`relative overflow-hidden w-full  ${
                        index % 2 === 0 ? 'aspect-[9/16] md:aspect-[2/3]' : 'aspect-[16/9] md:aspect-[3/2]'
                      }`}
                    >
                      <motion.div
                        style={{ scale }}
                    ...
                    <div className={`flex justify-between items-center w-full  mt-4 ${
                      ...
                      <div className={`flex items-center gap-2 ${index % 2 === 0 ? '' : 'flex-row-reverse'}`}>
